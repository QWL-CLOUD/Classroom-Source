...
export const CATEGORY_FAMILIES = [
  ...
  },
  {
    id: 'subject',
    label: 'Subjects',
    description: 'Canonical subject areas used to organize Library content.',
  ...
  },
  {
    id: 'grade-level',
    label: 'Grade Levels',
    description: 'Grade levels or grade bands for reusable Library content.',
    selectionMode: 'multiple',
    entityTypes: ['library-item'],
    assignmentAvailability: 'current',
  },
  {
    id: 'language',
    label: 'Languages',
    description: 'Languages used by or supported through Library content.',
    selectionMode: 'multiple',
    entityTypes: ['library-item'],
    assignmentAvailability: 'current',
  },
  {
    ...
    description: 'Instructional language levels for reusable Library content.',
    selectionMode: 'multiple',
    entityTypes: ['library-item'],
    assignmentAvailability: 'current',
  },
  {
    ...
    description: 'The primary instructional format of a reusable Activity.',
    selectionMode: 'single',
    entityTypes: ['library-item'],
    assignmentAvailability: 'current',
  },
