...
const instructions = [
  ...
  [
    'Subject, Grade Level, Language, Language Level, Purpose, and Skill resolve to controlled classifications. Multiple values may use semicolons, vertical bars, or line breaks.',
  ],
